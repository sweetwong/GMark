GMark is an Android Application support git operation and markdown preview, it also contains a lightweight editor where you can modify your code and then commit and push to git repository in.
